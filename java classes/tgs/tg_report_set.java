...
public String tg_report(
  ...
  )
    {
        ...
        { 
        tg_report1(tgid, common_ancestor, propositus);
        return "Completed";
        }
     }
    ...
    public static void main(String args[]) {
        tg_report1(Long.valueOf(109), Long.valueOf(11), Long.valueOf(1));
    }
    
    public static void tg_report1(Long tgid, Long common_ancestor, Long propositus) {
