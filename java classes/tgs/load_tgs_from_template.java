...
public class load_tgs_from_template {
  ...
  public String load_curated_tg_file(
  ...
  )
    {
        ...
        load_tgs_from_csv(CSVFilePath, db);
...
return "Completed";
    ...
    public static void main(String args[]) {
        load_tgs_from_csv("E://DAS_Coded_BU_2017/Genealogy/WhoAmI/django/data/Teves Project/Teves_tgs_20210909_0900.csv", "test");
    }
    
    public static String load_tgs_from_csv(String csvFile, String db) {
        ...
        neo4j_qry.qry_write("match (t:tg)-[r]-() delete r", db);
