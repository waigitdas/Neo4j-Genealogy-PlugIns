...
//           Long common_ancestor,
  ...
  )
    {
        ...
        String s = tg_report1(tgid, propositus, common_ancestor, anonymized);
        return s;
        }
     }
    ...
    public static String tg_report1(Long tgid, Long propositus, Long common_ancestor,Boolean anonymized) {
