               ...
               String tmp[]=cc[1].split(Pattern.quote("|"));
                ...
                fwp.write("tgid|from|to\n");
                    ...
                    // last tgid on chr
                            ...
                            cq = "MATCH p=(t)-[r:tg_seg]->(s) with r,t.tgid as t,t.name as n, r.tgid as rt,s.Indx as seg  set r.tg_name=n";
                            neo4j_qry.qry_write(cq);
                            cq = "MATCH p=()-[r:seg_seq]->() with r match (t:tg{tgid:r.tgid}) set r.tg_name=t.name";
                            neo4j_qry.qry_write(cq);
            }
