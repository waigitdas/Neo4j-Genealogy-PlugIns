...
public class triangle_ct {
    @UserFunction
    @Description("Triangle counts for DNA_Matches in virtual graph created using the submitted parameters.")
    ...
    public String triangle_count(
        ...
        String s = get_triangles("triangle count", min_cm, max_cm, known_matches_only);
         return s;
            }
