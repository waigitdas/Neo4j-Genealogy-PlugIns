...
public class upload_Y_DNA_Haplotree {
    ...
    public static void main(String args[]) {
        upload_FTDNA_Y_haplotree("E:/DAS_Coded_BU_2017/Genealogy/DNA/Haplotrees/FTDNA/Y_210908.json", "test");
    }
    
    public static void upload_FTDNA_Y_haplotree(String FTDNA_json_file, String db) {
