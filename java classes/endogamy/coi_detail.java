...
public class coi_detail{
  ...
  )
    {
        ...
        for (int i=0; i<mrca.length; i++){
            ...
            String probands = gen.gedcom.get_person.getPersonFromRN(rn1, false) + " ; " + gen.gedcom.get_person.getPersonFromRN(rn2, false);
            String anc = gen.gedcom.get_person.getPersonFromRN(anc_rn, false);
