...
public class triangulated_segments {
    @UserFunction
    ...
    public String triangulated_segment_matches(
        ...
        get_matches_segments(match_type, min_cm, max_cm, known_matches_only);
         return "";
            }
    ...
    public static void main(String args[]) {
     ...
     public String get_matches_segments(Long match_type, Long min_cm, Long max_cm,Boolean known_matches_only)
    {
       ...
       String excelFile="";
        ...
        if (known_matches_only ) {
            if (match_type.equals(1L)) {  //shared_matches
            ...
            if (match_type.equals(1L)) {  //shared matches
       ...
       gen.excelLib.queries_to_excel.qry_to_excel(cq, "Triangulated_segments", "seg_matches", 2, "", "1:####;2:####", excelFile, true, "UDF: \nreturn gen.discovery.triangulated_segment_matches(" + match_type + "," + min_cm + "," + max_cm + "," + known_matches_only + ")\n\nMatch_ type: " + match_type + " with shared centimorgan range of " + min_cm + " to " +  max_cm + "\nThese analytics use the Neo4j Graph Data Science PlugIn\nThe virtual graph created had " + node_ct + " nodes and  " + rel_ct +" relationships\n\nvirtual graph query:\n" + cqv + "\n\nalgorithm query:\n" + cq  , true);
