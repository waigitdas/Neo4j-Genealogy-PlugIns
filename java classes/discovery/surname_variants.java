...
public class surname_variants {
     ...
     public String get_matches(String variant_spellings) 
    {
        ...
        gen.excelLib.queries_to_excel.qry_to_excel(cq, vs[0] + "_matches", "matches", 1, "", "1:##;2:###,###,###;3:###,###,###;4:###;5:####.#;7:###;8:####", "", true, "UDF: return gen.discovery.matches_by_surname('" + variant_spellings + "')\n\nquery:\n" + cq, true);
        return "completed";
    }
}
