...
public class avatar_parental_cm {
     ...
     public static String get_cm() 
    {
       ...
       //merge segments, computertheir cm and create avSegments
        ...
        gen.neo4jlib.neo4j_qry.qry_write("MATCH p=(a)-[r:avatar_avsegment]->(s) where r.side='paternal' with a,sum(s.cm) as cm set a.paternal_cm = cm");
        ...
        gen.neo4jlib.neo4j_qry.qry_write("MATCH p=(a)-[r:avatar_avsegment]->(s) where r.side='unknown' with a,sum(s.cm) as cm set a.unknown_cm = cm");
         gen.neo4jlib.neo4j_qry.qry_write("MATCH p=(a)-[r:avatar_avsegment]->(s:avSegment)  with distinct a,a.fullname as fn,s with a,fn,sum(s.cm) as cm set a.dna_coverage=cm/7200,a.total_cm=cm");
