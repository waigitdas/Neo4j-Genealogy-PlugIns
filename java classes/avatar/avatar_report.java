...
public class avatar_report {
     ...
     public static String get_report(Long rn) 
    {
        ...
        gen.neo4jlib.neo4j_qry.qry_to_csv(cq,"avatar_" + rn + "_dna_painter" + "_" + gen.genlib.current_date_time.getDateTime()  + ".csv");       return "";
    }
}
