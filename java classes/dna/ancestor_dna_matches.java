...
//            Long rn2
    ...
    public static String ancestor_descendant_matches(Long rn) {
        ...
        String q = gen.excelLib.queries_to_excel.qry_to_excel(cq,"descendant_matches","Descendants", 1, "2:10;3:75", "2:####;2:####", "", true,"UFD: gen.dna.ancestor_descendants_with_dna_test(" + rn + ")",true);
        return q;
    }
