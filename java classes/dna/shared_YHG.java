...
public class shared_YHG {
    ...
    public static void main(String args[]) {
     ...
     public static String shared_hg() 
    {
        ...
        gen.neo4jlib.neo4j_qry.qry_write(cqx.replace("[[","[").replace("]]","]"));
