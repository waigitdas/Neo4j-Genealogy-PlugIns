...
public class mt_variant_list {
    @UserFunction
    @Description("in development. process SNP with anomalist values.")

    public List<String> mt_variant_in_list(
        @Name("proband_list") 
        ...
        List<String> r = compare_variant_lists(proband_list,ref_list);
         return r;
            }
    ...
    compare_variant_lists(s1,s2);
    
    }
    
     public static List<String> compare_variant_lists(List<String> pl, List<String> rl)
    {
