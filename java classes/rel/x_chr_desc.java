...
public class x_chr_desc {
     ...
     public String get_desc(Long anc_rn) 
    {
        ...
        String r = gen.excelLib.queries_to_excel.qry_to_excel(cq, "X chr descendants", "descendants", 1, "", "2:###;4:#####", "", true,"Candidates for inheriting X-chr from " + gen.gedcom.get_family_tree_data.getPersonFromRN(anc_rn, true));
        return r;
    }
}
