...
public class add_rel_property {
     ...
     public String add_rel()
    {
        ...
        String cq ="MATCH (m1:DNA_Match)-[r:match_segment]->(s:Segment) where r.p_rn>0 and r.m_rn>0 with distinct r.p_rn as rn1,r.m_rn as rn2 with rn1,rn2,gen.rel.relationship_from_RNs(rn1,rn2) as rel1 with rn1,rn2,rel1 where trim(rel1)>' ' with rn1,rn2,collect(rel1) as rel2 return  rn1, rn2,apoc.text.join(rel2, ' ') as rel order by rn1,rn2"; 
