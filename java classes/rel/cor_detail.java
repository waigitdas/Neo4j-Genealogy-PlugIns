...
public class cor_detail{
  ...
  )
    {
        ...
        //get all MRCAs
        double cor = 0.0;
        String fname = neo4j_info.Import_Dir + "cor_details_" + rn1 + "_" + rn2 + "_" + gen.genlib.current_date_time.getDateTime() + ".csv";
