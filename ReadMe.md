...
The project priorities will depend, in part, on developer interests and requests from end users. These are summarized at <a href="https://www.wai.md/post/neo4j-genealogy-plugin" target="new">https://www.wai.md/post/neo4j-genealogy-plugin</a>, which will be updated periodically. For project management by developers we will use GitHub functionalities.
