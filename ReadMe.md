...
<ol>
  <li>A simple text file (<a href="https://github.com/waigitdas/Neo4j-Genealogy-PlugIns/blob/main/implementation%20templates/neo4j-template.wai">template provided</a>) which contains information about your local enviroment needed to run the tools.
  ...
  <li>A curated Excel file (<a href="https://github.com/waigitdas/Neo4j-Genealogy-PlugIns/blob/main/implementation%20templates/Family%20ftdna%20curation%20file.xlsx">template provided</a>) linking GEDCOM person identifiers (from the @I###@ tags) with DNA results (names and kit numbers). This takes some effort but the benefits are notable and actionable.
