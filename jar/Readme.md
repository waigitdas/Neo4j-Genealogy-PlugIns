...
<ol>
  <!--<li><b>v 1.0.16</b>.
   ...
   <li>Fix to ancestor reconstruction algorithm's generation of a DNA Painter file.
    ...
    <li><b>v 1.0.14</b>. Added enforcing creation of the HapMap before loading other data. Added a new function for computing DNA coverage for any ancestor who has descendant DNA testers. <li><b>v 1.0.15</b>. Added function to add DNA testers whose DNA is not in the project. Supported by new Person property at_DNA_tester.
